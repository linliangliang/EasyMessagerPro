package com.zhengyuan.baselib.broadcasts;
...
public class BroadcastReceiverAddFriend extends BroadcastReceiver {
    ...
    String serverNameString = BaseXmppManager.getConnection().getServiceName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (response == null) {// 当response==null时，为收到添加请求
            ...
            if (ToolClass.isFriend(alertSubName)) {
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ToolClass.getContext());
                    builder.setTitle("添加好友请求");
                    builder.setMessage("用户\"" + friendNickName + "\"请求添加你为好友");
                    builder.setPositiveButton("同意", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BaseXmppManager.getConnection().sendPacket(presenceRes);
    ...
    public boolean addFriend(Roster roster, String friendName, String name) {
        try {
            roster.createEntry(friendName.trim() + "@"
                            + BaseXmppManager.getConnection().getServiceName(), name,
                    new String[]{"Friends"});
