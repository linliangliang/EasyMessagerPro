...
public final class BOSHClient {
     ...
     */
    private void applyRoute(final ComposableBody.Builder builder) {
        assertLocked();
     ...
     */
    private void applyFrom(final ComposableBody.Builder builder) {
        assertLocked();
    ...
    private void applyResponseAcknowledgement(
            final ComposableBody.Builder builder,
            final long rid) {
        assertLocked();
