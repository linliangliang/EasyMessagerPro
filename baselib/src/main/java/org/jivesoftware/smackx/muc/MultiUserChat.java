...
public class MultiUserChat {
    ...
    public void sendMessage(String text) throws XMPPException {
        ...
        message.setFrom(EMProApplicationDelegate.userInfo.getUserId().split("/")[0]);
        message.setBody(text);
        this.messageID=message.getPacketID();
       // message.addExtension(extension)
        connection.sendPacket(message);
    }
//modified 2016.11.21 带mid的重载方法
    public void sendMessage(String text,String mid) throws XMPPException {
        Message message = new Message(room,Message.Type.groupchat);
        message.setFrom(EMProApplicationDelegate.userInfo.getUserId().split("/")[0]);
        message.setBody(text);
        message.setPacketID(mid);
        this.messageID=message.getPacketID();
       // message.addExtension(extension)
        connection.sendPacket(message);
    }
